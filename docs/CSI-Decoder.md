# WL-Local-Server Feature Branch: CSI-Decoder

## Description

This branch is about debugging the CSI Decoder in the nexcsiserver.py script, fixing the issues with CSI real and imaginary data not being decoded and sent properly over MQTT.

## Key Changes

This feature introduces the following changes:

- Reworked the entire CSI decoding process in the nexcsiserver.py script.
- Further implemented error handling to reduce freezes as well as implementing restart and reload protocols.
