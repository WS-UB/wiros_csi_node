...
E_MASK = (1 << 6) - 1  # 6-bit exponent (bits [0:5])
R_MANT_MASK = ((1 << 11) - 1) << 18  # Real mantissa (bits [18:28])
I_MANT_MASK = ((1 << 11) - 1) << 6  # Imag mantissa (bits [6:16])
R_SIGN_MASK = 1 << 29  # Real sign (bit 29)
I_SIGN_MASK = ((1 << 11) - 1) << 6  # Imag sign (bit 17)
COUNT_MASK = 1 << 10  # For mantissa normalization check (bit 10)
MANT_MASK = (1 << 10) - 1  # Lower 10 bits of mantissa
